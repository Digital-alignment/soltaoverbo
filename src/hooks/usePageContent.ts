...
export const DEFAULT_CMS_DATA: SiteCMSData = {
  ...
  programa_21_dias: {
    ...
    trilha: {
      ...
      sem1_desc: "antes de qualquer outra coisa, existe você. esta semana é um convite para parar, respirar e voltar para dentro.",
      ...
      sem2_desc: "o mundo ao nosso redor está cheio de espelhos. esta semana amplia o olhar: de dentro para fora.",
      ...
      sem3_desc: "duas semanas de olhar, pra dentro e pra fora. agora é hora de tecer: integrar o que ficou dentro com o que você percebeu fora.",
