...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: '#b6c700' }}>
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl border border-darkNeutral/10 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="displayName" className="block text-sm font-medium text-darkNeutral mb-2">
                nome de exibição
              </label>
              <input
                id="displayName"
            ...
            <button
              ...
              onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#a0b000'}
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#b6c700'}
            >
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 rounded-lg text-darkNeutral font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed group"
            style={{ borderColor: '#b6c700' }}
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = '#b6c700';
              e.currentTarget.style.color = 'white';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.backgroundColor = 'transparent';
              e.currentTarget.style.color = '#2D2A2E';
            }}
          >
          ...
          <div className="mt-6 text-left">
            <Link
              ...
              style={{ backgroundColor: '#1f008f', color: 'white' }}
