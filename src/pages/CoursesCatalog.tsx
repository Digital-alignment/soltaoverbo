...
export default function CoursesCatalog() {
  ...
  return (
    <div className="min-h-screen bg-bgPlataforma text-tintaCarvao pb-24 relative overflow-x-hidden">
      <UserNavbar />
      <FloatingNavbar />

      {/* ILUSTRAÇÃO DE COLLAGE FIXA DE FUNDO EM DESKTOP (EXTREMO DIREITO DA TELA) */}
      <div className="hidden md:block absolute top-16 right-0 lg:right-2 pointer-events-none z-0">
        <img
          src="/brand-assets/elements/collages/collage final bk desktp.png"
          alt="ilustração solta o verbo desktop"
          className="h-72 lg:h-96 w-auto object-contain opacity-95"
        />
      </div>

      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:pl-28 pt-1 sm:pt-2 space-y-4 relative z-10">
        
        {/* ILUSTRAÇÃO DE COLLAGE EM MOBILE (ALINHADA À ESQUERDA NO TOPO) */}
        <div className="block md:hidden pt-1 pb-1">
          <img
            src="/brand-assets/elements/collages/collage final bk mobile.png"
            alt="ilustração solta o verbo mobile"
            className="h-[150px] sm:h-[180px] w-auto object-contain"
          />
        </div>

        {/* CONTAINER DE CONTEÚDO (MENOR LARGURA EM DESKTOP PARA NÃO ATRAVESSAR A ILUSTRAÇÃO DE FUNDO) */}
        <div className="w-full md:max-w-[72%] lg:max-w-[76%] xl:max-w-[78%] space-y-4">
          
          {/* CABEÇALHO DA PÁGINA (SUBIDO MAIS ALTO) */}
          <div className="space-y-2.5 border-b border-papelKraft/40 pb-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 items-stretch pt-1">
